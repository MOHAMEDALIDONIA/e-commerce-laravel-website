                                    ...
                                    <div class="tab-content col-md-9" id="v-pills-tabContent">
                                        ...
                                        <div class="tab-pane fade" id="onlinePayment" role="tabpanel" aria-labelledby="onlinePayment-tab" tabindex="0">
                                            ...
                                            <hr/>
                                               ...
                                               <a href="{{ route('make.payment') }}" > <button type="button"  wire:loading.attr="disabled" class="btn btn-warning">Pay Now (Online Payment)</button></a>
                                        </div>
                                    </div>
                                </div>
...
{{-- @push('scripts')
 <script src="https://www.paypal.com/sdk/js?client-id=Aft1fU3LCE8aoj0xkpZD8mDgaPBwF2MWhAbpzDiogGwpppNBpIL4XMpgTpwkBWi9eOT1-c48WZ71C1VQ&components=buttons"></script>
 <script >
